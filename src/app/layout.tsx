...
export const metadata: Metadata = {
  title: "Medical Cannabis Store | Quality Products & Consultation",
  description: "Professional medical cannabis products. Lab-tested, licensed, and recommended. Schedule your consultation with healthcare professionals today.",
  keywords: "medical cannabis, CBD products, THC therapy, cannabis store, medical marijuana",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "MediCare Cannabis | Medical Cannabis Products",
    description: "Quality medical cannabis products with professional healthcare consultation.",
    type: "website",
